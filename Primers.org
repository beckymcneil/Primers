* Lab procedures at CGI
This repo contains material and methods that we use at the Center for
Genetic Identification at NRM. We strive at using published methods
and are not unless needed testing new methods. 

Most of our projects fall into three main categories. 

** Species determination from tissue samples or remains from organisms.
This is the most common projects at CGI. We have successfully
determined species from tissue, fish eggs, feathers, muscle tissue,
plant tissue, hair, blood stains, bones, seeds etc

For this projects we are most often simply amplifying short pieces of
mitochondria or chloroplast and sequencing the amplicon with sanger
sequencing.

In many cases we can use general primers that can amplify for example
12s or 16s in a given organism groups. If we are studying mammals we
tend to use species specific primers to avoid amplifying human DNA
that is often abundant in the samples we recieve.

** Species identification from environmental samples
eDNA anaysis is increasing popular in environmental monitoring
programs. Today we are currently using two methods for detecting DNA
traces from environmental samples. The first method look a individual
species and detect DNA traces by using qPCR. To be successful one need
to know which species one wants to detect and identify (or develop) a
method that are specific for the species. For many freshwater fish
species, frogs, salamanders found in Sweden there are methods
available.

| Species               | Method | Annealing | Tested at CGI | Comment                 | Reference   |
|-----------------------+--------+-----------+---------------+-------------------------+-------------|
| Aspius aspius         | Taqman |        60 | Yes           |                         | Dev. at CGI |
| Salmo trutta          | Taqman |   60 (55) | Yes           | Works at 55-60          |             |
| Salmo salar           | Taqman |        60 | Yes           |                         |             |
| Salvelinus alpinus    | Taqman |        55 | Yes           | Hard to sep. Salvelinus |             |
| Salvelinus fontinalis | Taqman |        55 | Yes           | Hard to sep. Salvelinus |             |
| Lota lota             | Taqman |        60 | Yes           |                         |             |
...
1. Standard primers (for amplification/sanger sequencing), Std
2. NGS primers for metabarcoding
3. SSR primers where at least one primers have a flourescent
   modifications
4. qPCR primers which in most cases have a probe that works in
